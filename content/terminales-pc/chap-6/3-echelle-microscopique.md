...
9. Exprimer l’expression de cette concentration molaire pour un gaz obéissant au modèle du gaz parfait et en déduire sa valeur à $\pu{400 K}$ et $\pu{1e5 Pa}$.
{{% solution "Réponse" %}}
